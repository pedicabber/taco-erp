...
const sheetVariants = cva(
  "fixed z-50 flex flex-col overflow-hidden bg-background p-6 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
...
const SheetBody = ({
  ...
  <div className={cn(scrollableBodyClass, className)} {...props} />
)
